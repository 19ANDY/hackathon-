...
ArduinoSerial2 = serial.Serial('com3',9600)
time.sleep(2)
t = 9897550614153
r = 26390579686429
s = 73669285398244
                ...
                try:
                    ...
                    if(y == 'hello'):
                        ...
                        if a==1:
                                ...
                                db = MySQLdb.connect(host="localhost",user="aecs1",passwd="aecs1",db="home")
                                cur = db.cursor()
                                cur.execute("INSERT INTO access(RFID,NAME,EMAIL) VALUES('0000000','Face User','saurabh2206@gmail.com')")
                                db.commit()
                                db.close()
                                ArduinoSerial1.write('0')
                                ArduinoSerial2.write('0')
                                ...
                                server.sendmail("radheysen0@gmail.com","saurabh2206@gmail.com","Hi Face User, You have accessed your gate")
                                server.quit()
                        elif a==0:
